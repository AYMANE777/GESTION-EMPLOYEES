...
<div class="menu-item">
	<a class="menu-link <?php echo $pages["problems"]; ?>" href="assistance">
		<span class="menu-icon">
			<span class="svg-icon svg-icon-1">
...
<div class="menu-item">
	<a class="menu-link <?php echo $pages['entretiens']; ?>" href="mes-entretiens">
		<span class="menu-icon">
			<span class="svg-icon svg-icon-1">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div class="menu-item ">
	<a class="menu-link <?php echo $pages['tuto']; ?>" href="support">
		<span class="menu-icon">
			<span class="svg-icon svg-icon-1">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
